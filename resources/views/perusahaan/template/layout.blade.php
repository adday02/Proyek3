          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{URL::to('/')}}/logo/{{auth()->user()->logo}}" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="{{URL('perusahaan/dashboard')}}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                  ...
                  <li><a><i class="fa fa-building"></i> Pekerjaan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{URL('perusahaan/lamaran-Perusahaan')}}">Lamaran Pekerjaan</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{URL::to('/')}}/logo/{{auth()->user()->logo}}" alt="">{{auth()->user()->nama}}
